    ...
    return (
        <div className="min-h-screen bg-background flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                    ...
                    <div className="flex items-start gap-3 mb-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-red-700">
                                Something unexpected happened. Please try again or contact support if the problem
                                persists.
                            </p>
                        </div>
                    </div>
                ...
                <Button onClick={handleReset(resetErrorBoundary)} className="w-full" variant="outline">
