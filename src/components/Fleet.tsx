...
import { Users, Briefcase, Shield, WhatsappLogo, CheckCircle } from '@phosphor-icons/react'
...
export function Fleet() {
    ...
    return (
        <section ref={ref} id="fleet" className="py-20 sm:py-24 md:py-32 px-5 sm:px-6 bg-gradient-to-b from-background via-background to-muted/10 relative overflow-hidden">
                                ...
                                <div className="p-7 sm:p-8 md:p-9 bg-card/95 backdrop-blur-sm">
                                    ...
                                    <div className="mb-7 sm:mb-8 md:mb-9">
                                        <h4 className="font-semibold text-foreground mb-5 sm:mb-5 flex items-center text-lg sm:text-lg">
                                            <Shield className="mr-2.5 sm:mr-2.5 text-accent" size={22} weight="fill" />
                                            Premium Features
                                        </h4>
                                        <ul className="grid grid-cols-1 gap-4 sm:gap-4">
                                            {vehicle.features.map((feature) => (
                                                ...
                                                >
                                                    <CheckCircle className="mr-3 sm:mr-3 text-accent flex-shrink-0 group-hover/item:scale-110 transition-transform" size={20} weight="fill" />
                                                    {feature}
                                                </motion.li>
                                            ))}
                                        </ul>
