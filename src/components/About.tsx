                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 sm:gap-16 md:gap-20 items-center">
                    ...
                    >
                        ...
                        >
                            ...
                            <p className="text-base leading-[1.7] sm:text-lg md:text-xl text-muted-foreground font-light">
                                Whether you're visiting for business or pleasure, traveling solo or with a group, 
                                we provide tailored transportation solutions that match your needs and exceed your expectations.
                            </p>
                        </motion.div>
                    </motion.div>
